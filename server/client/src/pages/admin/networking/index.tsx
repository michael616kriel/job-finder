...
class Networking extends Component {
    ...
    async getUsersNew(limit: any, offset: any) {
        try {
            const response = await axios.get(`${Config.apiUrl}/network-users`, {
                params: {
                    uid: this.context.user.uid,
    ...
    profileCard(key: any, user: any) {
        const profile: any = this.getProfile(user)
        return (
