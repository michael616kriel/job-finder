              ...
              <div className="card-body">
                ...
                <form className="form-signin" onSubmit={this.handleSubmit}>
                  ...
                  <div className="form-label-group">
                    <input onChange={this.handleChange} type="text" name="username" value={this.state.profile.username} id="inputUserame" className="form-control" placeholder="Username" required autoFocus />
                    <label htmlFor="inputUserame">Username</label>
                  </div>

                  <div className="form-label-group">
                    <input onChange={this.handleChange} type="text" name="email" value={this.state.profile.email} id="inputEmail" className="form-control" placeholder="Email address" required />
                  ...
                  <div className="form-label-group">
                    <input onChange={this.handleChange} type="text" name="password" value={this.state.profile.password} id="inputPassword" className="form-control" placeholder="Password" required />
